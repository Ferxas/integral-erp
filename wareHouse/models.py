...
class pickUpOrder(models.Model):
    customerName        =   models.ForeignKey(customer, blank=True, null=True, on_delete=models.DO_NOTHING, related_name='pick_up_orders')
    vendorName          =   models.ForeignKey(vendor, blank=True, null=True, on_delete=models.DO_NOTHING, related_name='pick_up_orders')
